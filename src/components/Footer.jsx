  ...
  return (
    <div>
        <div className=" sm:h-[100px] bg-[#161616] p-12 flex lg:flex-row flex-col justify-between items-center mx-auto">
            ...
            <p className='text-gray-600 text-center lg:text-lg text-sm'><FaLocationArrow className='inline-block mr-2' /> No.11, Adejokun Street, Isheri Ojodu Berger, Lagos State.</p> 
            </div>
            </div>
    </div>
  )
